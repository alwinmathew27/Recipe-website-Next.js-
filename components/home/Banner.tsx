        ...
        >
          ...
          >
            ...
            <div className="absolute inset-0 opacity-10">
              ...
              <div className="absolute top-20 right-20 text-5xl animate-pulse delay-100">
                {slide.emoji}
              </div>
              <div className="absolute bottom-20 left-20 text-7xl animate-bounce delay-200">
                {slide.emoji}
              </div>
              <div className="absolute bottom-10 right-10 text-6xl animate-pulse delay-300">
                {slide.emoji}
              </div>
            </div>
